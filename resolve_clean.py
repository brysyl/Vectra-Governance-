...
print("Step 1: Writing pristine, fully validated main.py...")
...
print("Step 2: Verifying local compilation and import...")
py_compile.compile("main.py", doraise=True)

# Test importability in a subprocess to ensure no runtime syntax/import faults
...
print("Step 3: Writing clean Dockerfile...")
...
print("Step 4: Committing and pushing to git...")
subprocess.run(["git", "add", "main.py", "Dockerfile"], check=True)
subprocess.run(["git", "commit", "-m", "Replace mangled main.py with pristine validated implementation"], check=True)
subprocess.run(["git", "push", "origin", "main"], check=True)

print("Step 5: Building and deploying to Cloud Run...")
